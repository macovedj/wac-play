(component
  ...
  (type (;23;)
    (component
      ...
      (import "wasi:cli/terminal-stderr@0.2.0-rc-2023-10-18" (instance (;13;) (type 22)))
      (type (;23;) (func (result string)))
      (export (;0;) "hello-world" (func (type 23)))
    )
  )
  ...
  (type (;24;)
    (component
      ...
      (import "component:goodbye/greeter" (instance (;0;) (type 0)))
      (type (;1;) (func (result string)))
      (export (;0;) "goodbye-world" (func (type 1)))
    )
  )
  (import "unlocked-dep=<wasi:goodbye>" (component (;1;) (type 24)))
  (instance (;15;) (instantiate 1
      (with "component:goodbye/greeter" (instance 14))
    )
  )
  (export (;16;) "salutation" (instance 15))
  (@producers
